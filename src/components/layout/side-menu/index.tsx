...
import { BsFillTruckFrontFill, BsCalendarWeek, BsFillClipboardDataFill, BsFillFuelPumpFill, BsAlarm, BsBuildings } from "react-icons/bs";
...
const links = [
  ...
  { label: "Unidentified Events", link: "/unidentified-events", Icon: BsCalendarWeek },
  { label: "DVIRs", link: "/dvirs", Icon: RiShieldCheckLine },
  {
    label: "Reports", link: "#", Icon: BsFillClipboardDataFill,
    links: [
  ...
  {
    label: "Maintenance", link: "#", Icon: AiFillSetting,
    links: [
  ...
  {
    label: "Manage", link: "#", Icon: MdOutlineManageHistory,
    links: [
      { label: "Drivers", link: "/manage-drivers", Icon: FaUser },
      { label: "Vehicles", link: "/manage-vehicles", Icon: BsFillTruckFrontFill },
